...
import resumePdf from "./Ananyarshetty-resume.pdf";
  ...
  return (
    <section className={`hero-section ${isDark ? "dark" : "light"}`} id="hero">
      ...
      <div className="hero-left">
       <h1>Hi, I'm Ananya R Shetty</h1>

<h2>
  Network Engineer | Cloud & DevOps | Generative AI | AIOps
</h2>

<p className="hero-description">
  Programmer Analyst Apprentice @ Cognizant | Python | Cloud | Networking | AIOps | Generative AI | ITSM
</p>

<p className="hero-description">
  Software Engineer focused on building reliable enterprise solutions across
  cloud computing, automation, DevOps, Generative AI, and IT Operations.
  Experienced with AWS, Microsoft Azure, GCP, Docker, Kubernetes, Terraform,
  Linux, networking, monitoring, observability, LLMs, LangChain, and Agentic AI,
  with a strong interest in building intelligent and scalable cloud-native systems.
</p>
